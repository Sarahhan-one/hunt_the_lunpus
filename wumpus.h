...
uint16_t windNorthSouthMask[]  =
  {0xFE7E, 0xDDDD, 0xBBBB, 0xEBEB, 0x77F7, 0xFFFF, 0xFFFF};
uint16_t windEastWestMask[]  =
  {0x4FFF, 0x36FF, 0xF9FF, 0x7F7F, 0xFF4F, 0xFF36, 0xFFF9};

uint8_t wumpusBiteFrames[]  = {15, 0x30, 0x06, 0x79, 0x4F, 0x01, 0x81, 0x23, 0xA3, 0x54, 0x54, 0x88, 0x08, 0x67, 0x73};
uint8_t wumpusBumpFrames[]  = {9, 0x06, 0x30, 0x46, 0x70, 0x28, 0x05, 0x20, 0x04};
uint8_t batFlapFrames[]  = {8, 0x23, 0x23, 0x40, 0x40, 0x0C, 0x18, 0x40, 0x40};
uint8_t pitfallFrames[]  = {12, 0x00, 0x00, 0x42, 0x50, 0x39, 0x0F, 0x00, 0x00, 0x44, 0x60, 0x39, 0x0F};

uint8_t arrowSelectFrames1[]  = {12, 0x06, 0x01, 0x06, 0x02, 0x06, 0x04, 0x06, 0x08, 0x06, 0x10, 0x06, 0x20};
uint8_t arrowSelectFrames2[]  = {12, 0x5B, 0x01, 0x5B, 0x02, 0x5B, 0x04, 0x5B, 0x08, 0x5B, 0x10, 0x5B, 0x20};
uint8_t arrowSelectFrames3[]  = {12, 0x4F, 0x01, 0x4F, 0x02, 0x4F, 0x04, 0x4F, 0x08, 0x4F, 0x10, 0x4F, 0x20};
uint8_t arrowSelectFrames4[]  = {12, 0x66, 0x01, 0x66, 0x02, 0x66, 0x04, 0x66, 0x08, 0x66, 0x10, 0x66, 0x20};
...
uint8_t batNearbyFrames[]  = {0x80, 0x80, 0x00, 0x00};
